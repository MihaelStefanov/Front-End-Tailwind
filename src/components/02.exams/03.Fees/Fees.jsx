...
export default function Fees() {
    ...
    return (
        <section className=' bg-white'>
            ...
            <section className='flex flex-col justify-center items-center bg-[#54546D] h-[360px] relative'>
                <h1 className='absolute top-6 text-3xl font-bold text-white mt-6  text-center'>Такси</h1>

                <div style={{ backgroundImage: `url(${calculator})` }}
                    className='w-[420px] h-[250px] left-[0px] top-[4em] bg-cover bg-center self-center absolute z-[5]'>

                </div>

                <div className='flex justify-center py-[2em] px-[3em] gap-[2em] z-[10] absolute bottom-[-10em]'>

                    <div className='flex flex-col  overflow-hidden w-[480px] self-start rounded-[0.8em] shadow-xl/20'>
                        <div className='flex flex-col bg-white px-[2em] pt-[1.5em] items-center'>
                    ...
                    <div className='flex flex-col  overflow-hidden w-[480px] self-start rounded-[0.8em] shadow-xl/20 '>
                        <div className='flex flex-col bg-white px-[1.5em] pt-[1.5em] items-center text-center '>
                            <h1 className='text-[1.8em] mb-[0.5em] font-bold opacity-65'>Fundamentals Program</h1>
                            <p className=' mb-[1em]'>Курсистите ще продължат обучението си в 6 фундаментални курса, покриващи основните сфери на дизайна и визуализацията.</p>
            ...
            <section className='flex flex-col pt-[23em] px-[6em] gap-[2em] justify-center mb-[6em]' >

                <h1>Присъствено или Онлайн</h1>
                <p className='mb-[1.8em]'>Формите на обучение в SoftUni Digital са две – присъствена и онлайн, така че обучението е подходящо, както за учещи и работещи, така и за курсисти, живеещи във всяка точка на света. Студентите могат да избират дали желаят да се обучават присъствено или онлайн за всеки отделен модул от учебния план.</p>
